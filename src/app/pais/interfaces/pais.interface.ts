...
export class Convert {
  public static toPaisResponse(json: string): PaisResponse[] {
      return cast(JSON.parse(json), a(r("PaisResponse")));
  }

  public static paisResponseToJson(value: PaisResponse[]): string {
      return JSON.stringify(uncast(value, a(r("PaisResponse"))), null, 2);
  }
}
